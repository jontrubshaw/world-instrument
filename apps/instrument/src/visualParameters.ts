...
export function mapScoreOutputToVisualParameters(output: ScoreOutput): InstrumentVisualParameters {
  ...
  return {
    ...
    rotationSpeedX: round(0.12 + motion * 0.65 + wind * 0.28),
    rotationSpeedY: round(0.18 + motion * 0.85 + wind * 0.36),
    innerRotationSpeed: round(0.3 + humidity * 0.42 + tension * 0.48),
    pulseAmplitude: round(0.055 + precipitation * 0.16 + wind * 0.12),
    pulseRate: round(1.25 + motion * 3.2 + precipitation * 1.2),
